        ...
        <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <img src="../images/logo.jpg" style="border-radius: 50%; height:140px; width:160px; " alt=""
                        srcset="">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <p class='sidebar-sub-title text-white ' style="margin-bottom:-5px; text-align:center;">Member
                        </p>
