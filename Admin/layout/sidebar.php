...
<body>
    ...
    <div class="sidebar-header">
        <img src="../images/logo.jpg"  style="height:140px; width:160px; border-radius: 50%; " alt="" srcset="">
    </div>
    ...
    <p class='sidebar-sub-title text-white ' style="margin-bottom:-5px; text-align:center;">Admin</p>
                ...
                <li class="sidebar-item <?php if($page=='task'){ echo 'active'; }?> ">
                ...
                <li class="sidebar-item  has-sub <?php if($page=='trainer'){ echo 'active'; }?>">
                    ...
                    <ul class="submenu ">
                        ...
                        <li>
                            <a href="status_trainer.php">Status</a>
                        </li>
                    </ul>
                </li>
