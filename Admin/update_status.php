                    ...
                    <form class="form form-vertical" action="action/payment.php?=<?php echo $row['user_id']; ?>" method="POST">
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group has-icon-left">
                                        <label for="mobile-id-icon">Ammount Per Plan</label>
                                        <div class="position-relative">
                                            <input type="text" class="form-control" name="amount" value='<?php echo $row['amount']?>'  placeholder="Total Amount" id="city-id-icon" required>
                                            <div class="form-control-icon">
                                                <i>(P)</i>
                                            </div>
                                        </div>
